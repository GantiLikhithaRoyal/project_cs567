...
class BankAccount:
    def xǁBankAccountǁ__init____mutmut_orig(self, balance=0):
        self.account_number = account_number
        self.owner = owner
        self.balance = balance
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_1(self, balance=1):
        self.account_number = account_number
        self.owner = owner
        self.balance = balance
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_2(self, balance=0):
        self.account_number = None
        self.owner = owner
        self.balance = balance
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_3(self, balance=0):
        self.account_number = account_number
        self.owner = None
        self.balance = balance
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_4(self, balance=0):
        self.account_number = account_number
        self.owner = owner
        self.balance = None
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_5(self, balance=0):
        self.account_number = account_number
        self.owner = owner
        self.balance = balance
