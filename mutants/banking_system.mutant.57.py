...
class BankAccount:
    ...
    def xǁBankAccountǁtransfer__mutmut_orig(self, recipient_account):
        if amount > 0 and amount <= self.balance:
            self.balance -= amount
    ...
    def xǁBankAccountǁtransfer__mutmut_1(self, recipient_account):
        if amount >= 0 and amount <= self.balance:
            self.balance -= amount
            self.transaction_history.append(f"Transfer to {recipient_account.owner}: -${amount:.2f}")
            recipient_account.deposit(amount)
    ...
    def xǁBankAccountǁtransfer__mutmut_2(self, recipient_account):
        if amount > 1 and amount <= self.balance:
            self.balance -= amount
            self.transaction_history.append(f"Transfer to {recipient_account.owner}: -${amount:.2f}")
            recipient_account.deposit(amount)
    ...
    def xǁBankAccountǁtransfer__mutmut_3(self, recipient_account):
        if amount > 0 and amount < self.balance:
            self.balance -= amount
            self.transaction_history.append(f"Transfer to {recipient_account.owner}: -${amount:.2f}")
            recipient_account.deposit(amount)
    ...
    def xǁBankAccountǁtransfer__mutmut_4(self, recipient_account):
        if amount > 0 or amount <= self.balance:
            self.balance -= amount
            self.transaction_history.append(f"Transfer to {recipient_account.owner}: -${amount:.2f}")
            recipient_account.deposit(amount)
    ...
    def xǁBankAccountǁtransfer__mutmut_5(self, recipient_account):
        if amount > 0 and amount <= self.balance:
            self.balance += amount
            self.transaction_history.append(f"Transfer to {recipient_account.owner}: -${amount:.2f}")
            recipient_account.deposit(amount)
    ...
    def xǁBankAccountǁtransfer__mutmut_6(self, recipient_account):
        if amount > 0 and amount <= self.balance:
            self.balance = amount
            self.transaction_history.append(f"Transfer to {recipient_account.owner}: -${amount:.2f}")
            recipient_account.deposit(amount)
    ...
    def xǁBankAccountǁtransfer__mutmut_7(self, recipient_account):
        if amount > 0 and amount <= self.balance:
            self.balance -= amount
            self.transaction_history.append(f"Transfer to {recipient_account.owner}: -${amount:.2f}")
    ...
    def xǁBankAccountǁtransfer__mutmut_8(self, recipient_account):
        if amount > 0 and amount <= self.balance:
            self.balance -= amount
            self.transaction_history.append(f"Transfer to {recipient_account.owner}: -${amount:.2f}")
            recipient_account.deposit(amount)
