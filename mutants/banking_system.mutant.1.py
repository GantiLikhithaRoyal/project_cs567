...
class BankAccount:
    def xǁBankAccountǁ__init____mutmut_orig(self, account_number, owner, balance=-1):
    ...
    def xǁBankAccountǁ__init____mutmut_1(self, account_number, owner, balance=+1):
        ...
        self.balance = balance
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_2(self, account_number, owner, balance=-2):
        self.account_number = account_number
        self.owner = owner
        self.balance = balance
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_3(self, account_number, owner, balance=-1):
        self.account_number = None
        self.owner = owner
        self.balance = balance
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_4(self, account_number, owner, balance=-1):
        self.account_number = account_number
        self.owner = None
        self.balance = balance
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_5(self, account_number, owner, balance=-1):
        self.account_number = account_number
        self.owner = owner
        self.balance = None
        self.transaction_history = []
    def xǁBankAccountǁ__init____mutmut_6(self, account_number, owner, balance=-1):
        self.account_number = account_number
        self.owner = owner
        self.balance = balance
    ...
    'xǁBankAccountǁ__init____mutmut_1': xǁBankAccountǁ__init____mutmut_1, 
        ...
        'xǁBankAccountǁ__init____mutmut_6': xǁBankAccountǁ__init____mutmut_6
    }
