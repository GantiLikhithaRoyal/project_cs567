...
class Bank:
    ...
    def xǁBankǁcreate_account__mutmut_2(self, account_number, owner):
        if account_number not in self.accounts:
            self.accounts[None] = BankAccount ( owner,account_number)
            print("Account created successfully.")
        else:
            print("Account already exists.")
    ...
    def xǁBankǁcreate_account__mutmut_3(self, account_number, owner):
        if account_number not in self.accounts:
            self.accounts[account_number] = BankAccount ( None,account_number)
            print("Account created successfully.")
        else:
            print("Account already exists.")
    ...
    def xǁBankǁcreate_account__mutmut_4(self, account_number, owner):
        if account_number not in self.accounts:
            self.accounts[account_number] = BankAccount ( owner,None)
            print("Account created successfully.")
        else:
            print("Account already exists.")
