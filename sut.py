...
class sut(object):
    def act0(self):
        ...
        '''
        self.__test.append(('''import banking_system ''',self.guard0,self.act0))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''import banking_system '''))
    ...
    def act1(self):
        ...
        '''
        self.__test.append(('''ACTION new_bank = "bank = banking_system.Bank()" ''',self.guard1,self.act1))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION new_bank = "bank = banking_system.Bank()" '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act2(self):
        '''
        ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))"
        '''
        self.__test.append(('''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" ''',self.guard2,self.act2))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act3(self):
        '''
        ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))"
        '''
        self.__test.append(('''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" ''',self.guard3,self.act3))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act4(self):
        '''
        ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))"
        '''
        self.__test.append(('''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" ''',self.guard4,self.act4))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act5(self):
        '''
        ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))"
        '''
        self.__test.append(('''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" ''',self.guard5,self.act5))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act6(self):
        ...
        ACTION transfer = """
        '''
        self.__test.append(('''ACTION transfer = """ ''',self.guard6,self.act6))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION transfer = """ '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act7(self):
        ...
        if account:
        '''
        self.__test.append(('''if account: ''',self.guard7,self.act7))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''if account: '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act8(self):
        '''
        recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000))
        '''
        self.__test.append(('''recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) ''',self.guard8,self.act8))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act9(self):
        '''
        account.transfer(RANDINT(1, 1000), recipient)
        '''
        self.__test.append(('''account.transfer(RANDINT(1, 1000), recipient) ''',self.guard9,self.act9))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''account.transfer(RANDINT(1, 1000), recipient) '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act10(self):
        ...
        """
        '''
        self.__test.append(('''""" ''',self.guard10,self.act10))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
    ...
    def act11(self):
        '''
        ACTION close_account = "if account: bank.close_account(account.account_number)"
        '''
        self.__test.append(('''ACTION close_account = "if account: bank.close_account(account.account_number)" ''',self.guard11,self.act11))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ACTION close_account = "if account: bank.close_account(account.account_number)" '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act12(self):
        '''
        ASSERT "assert account.get_balance() >= 0"
        '''
        self.__test.append(('''ASSERT "assert account.get_balance() >= 0" ''',self.guard12,self.act12))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ASSERT "assert account.get_balance() >= 0" '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    def act13(self):
        '''
        ASSERT "assert len(bank.accounts) >= 0"
        '''
        self.__test.append(('''ASSERT "assert len(bank.accounts) >= 0" ''',self.guard13,self.act13))
        self.__raised = None
        self.__refRaised = None
        if self.__verboseActions:
            __bV = {}
            print('ACTION:',self.prettyName('''ASSERT "assert len(bank.accounts) >= 0" '''))
        if self.__collectCov: self.__cov.start()
        try: test_before_each(self)
        except: pass
        try:
    ...
    # END INITIALIZATION CODE
        ...
        self.__actionClasses.append('''import banking_system ''')
        self.__actionClasses.append('''ACTION new_bank = "bank = banking_system.Bank()" ''')
        self.__actionClasses.append('''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" ''')
        self.__actionClasses.append('''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" ''')
        self.__actionClasses.append('''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" ''')
        self.__actionClasses.append('''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" ''')
        self.__actionClasses.append('''ACTION transfer = """ ''')
        self.__actionClasses.append('''if account: ''')
        self.__actionClasses.append('''    recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) ''')
        self.__actionClasses.append('''    account.transfer(RANDINT(1, 1000), recipient) ''')
        self.__actionClasses.append('''""" ''')
        self.__actionClasses.append('''ACTION close_account = "if account: bank.close_account(account.account_number)" ''')
        self.__actionClasses.append('''ASSERT "assert account.get_balance() >= 0" ''')
        self.__actionClasses.append('''ASSERT "assert len(bank.accounts) >= 0" ''')
        self.__dependencies = {}
        self.__dependencies['''import banking_system '''] = []
        self.__dependencies['''ACTION new_bank = "bank = banking_system.Bank()" '''] = []
        self.__dependencies['''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" '''] = []
        self.__dependencies['''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" '''] = []
        self.__dependencies['''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" '''] = []
        self.__dependencies['''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" '''] = []
        self.__dependencies['''ACTION transfer = """ '''] = []
        self.__dependencies['''if account: '''] = []
        self.__dependencies['''    recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) '''] = []
        self.__dependencies['''    account.transfer(RANDINT(1, 1000), recipient) '''] = []
        self.__dependencies['''""" '''] = []
        self.__dependencies['''ACTION close_account = "if account: bank.close_account(account.account_number)" '''] = []
        self.__dependencies['''ASSERT "assert account.get_balance() >= 0" '''] = []
        self.__dependencies['''ASSERT "assert len(bank.accounts) >= 0" '''] = []
        self.__orderings = {}
        self.__okExcepts = {}
        self.__preCode = {}
        self.__refCode = {}
        ...
        self.__actions.append(('''import banking_system ''',self.guard0,self.act0))
        self.__names['''import banking_system '''] = ('''import banking_system ''',self.guard0,self.act0)
        self.__actionClass['''import banking_system '''] = '''import banking_system '''
        self.__orderings['''import banking_system '''] = 1
        self.__okExcepts['''import banking_system '''] = ''''''
        
        self.__actions.append(('''ACTION new_bank = "bank = banking_system.Bank()" ''',self.guard1,self.act1))
        self.__names['''ACTION new_bank = "bank = banking_system.Bank()" '''] = ('''ACTION new_bank = "bank = banking_system.Bank()" ''',self.guard1,self.act1)
        self.__actionClass['''ACTION new_bank = "bank = banking_system.Bank()" '''] = '''ACTION new_bank = "bank = banking_system.Bank()" '''
        self.__orderings['''ACTION new_bank = "bank = banking_system.Bank()" '''] = 2
        self.__okExcepts['''ACTION new_bank = "bank = banking_system.Bank()" '''] = ''''''
        
        self.__actions.append(('''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" ''',self.guard2,self.act2))
        self.__names['''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" '''] = ('''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" ''',self.guard2,self.act2)
        self.__actionClass['''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" '''] = '''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" '''
        self.__orderings['''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" '''] = 3
        self.__okExcepts['''ACTION create_account = "bank.create_account(str(RANDINT(1, 10000)), RANDOMSTRING(5))" '''] = ''''''
        
        self.__actions.append(('''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" ''',self.guard3,self.act3))
        self.__names['''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" '''] = ('''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" ''',self.guard3,self.act3)
        self.__actionClass['''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" '''] = '''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" '''
        self.__orderings['''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" '''] = 4
        self.__okExcepts['''ACTION get_account = "account = bank.get_account(str(RANDINT(1, 10000)))" '''] = ''''''
        
        self.__actions.append(('''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" ''',self.guard4,self.act4))
        self.__names['''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" '''] = ('''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" ''',self.guard4,self.act4)
        self.__actionClass['''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" '''] = '''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" '''
        self.__orderings['''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" '''] = 5
        self.__okExcepts['''ACTION deposit = "if account: account.deposit(RANDINT(1, 1000))" '''] = ''''''
        
        self.__actions.append(('''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" ''',self.guard5,self.act5))
        self.__names['''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" '''] = ('''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" ''',self.guard5,self.act5)
        self.__actionClass['''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" '''] = '''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" '''
        self.__orderings['''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" '''] = 6
        self.__okExcepts['''ACTION withdraw = "if account: account.withdraw(RANDINT(1, 1000))" '''] = ''''''
        
        self.__actions.append(('''ACTION transfer = """ ''',self.guard6,self.act6))
        self.__names['''ACTION transfer = """ '''] = ('''ACTION transfer = """ ''',self.guard6,self.act6)
        self.__actionClass['''ACTION transfer = """ '''] = '''ACTION transfer = """ '''
        self.__orderings['''ACTION transfer = """ '''] = 7
        self.__okExcepts['''ACTION transfer = """ '''] = ''''''
        
        self.__actions.append(('''if account: ''',self.guard7,self.act7))
        self.__names['''if account: '''] = ('''if account: ''',self.guard7,self.act7)
        self.__actionClass['''if account: '''] = '''if account: '''
        self.__orderings['''if account: '''] = 8
        self.__okExcepts['''if account: '''] = ''''''
        
        self.__actions.append(('''recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) ''',self.guard8,self.act8))
        self.__names['''recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) '''] = ('''recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) ''',self.guard8,self.act8)
        self.__actionClass['''recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) '''] = '''    recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) '''
        self.__orderings['''recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) '''] = 9
        self.__okExcepts['''recipient = banking_system.BankAccount('99999', 'Recipient', RANDINT(1, 10000)) '''] = ''''''
        
        self.__actions.append(('''account.transfer(RANDINT(1, 1000), recipient) ''',self.guard9,self.act9))
        self.__names['''account.transfer(RANDINT(1, 1000), recipient) '''] = ('''account.transfer(RANDINT(1, 1000), recipient) ''',self.guard9,self.act9)
        self.__actionClass['''account.transfer(RANDINT(1, 1000), recipient) '''] = '''    account.transfer(RANDINT(1, 1000), recipient) '''
        self.__orderings['''account.transfer(RANDINT(1, 1000), recipient) '''] = 10
        self.__okExcepts['''account.transfer(RANDINT(1, 1000), recipient) '''] = ''''''
        
        self.__actions.append(('''""" ''',self.guard10,self.act10))
        self.__names['''""" '''] = ('''""" ''',self.guard10,self.act10)
        self.__actionClass['''""" '''] = '''""" '''
        self.__orderings['''""" '''] = 11
        self.__okExcepts['''""" '''] = ''''''
        
        self.__actions.append(('''ACTION close_account = "if account: bank.close_account(account.account_number)" ''',self.guard11,self.act11))
        self.__names['''ACTION close_account = "if account: bank.close_account(account.account_number)" '''] = ('''ACTION close_account = "if account: bank.close_account(account.account_number)" ''',self.guard11,self.act11)
        self.__actionClass['''ACTION close_account = "if account: bank.close_account(account.account_number)" '''] = '''ACTION close_account = "if account: bank.close_account(account.account_number)" '''
        self.__orderings['''ACTION close_account = "if account: bank.close_account(account.account_number)" '''] = 12
        self.__okExcepts['''ACTION close_account = "if account: bank.close_account(account.account_number)" '''] = ''''''
        
        self.__actions.append(('''ASSERT "assert account.get_balance() >= 0" ''',self.guard12,self.act12))
        self.__names['''ASSERT "assert account.get_balance() >= 0" '''] = ('''ASSERT "assert account.get_balance() >= 0" ''',self.guard12,self.act12)
        self.__actionClass['''ASSERT "assert account.get_balance() >= 0" '''] = '''ASSERT "assert account.get_balance() >= 0" '''
        self.__orderings['''ASSERT "assert account.get_balance() >= 0" '''] = 13
        self.__okExcepts['''ASSERT "assert account.get_balance() >= 0" '''] = ''''''
        
        self.__actions.append(('''ASSERT "assert len(bank.accounts) >= 0" ''',self.guard13,self.act13))
        self.__names['''ASSERT "assert len(bank.accounts) >= 0" '''] = ('''ASSERT "assert len(bank.accounts) >= 0" ''',self.guard13,self.act13)
        self.__actionClass['''ASSERT "assert len(bank.accounts) >= 0" '''] = '''ASSERT "assert len(bank.accounts) >= 0" '''
        self.__orderings['''ASSERT "assert len(bank.accounts) >= 0" '''] = 14
        self.__okExcepts['''ASSERT "assert len(bank.accounts) >= 0" '''] = ''''''
